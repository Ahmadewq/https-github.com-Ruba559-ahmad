...
<input type="text" name="text" placeholder="ادخل الاسم الكامل" size="20" required/><br>
<label>تاريخ الميلاد :</label>
<input type="date" name="month" size="30" required/><br>
<label> الجنس :</label>
<input type="text" name="gender" placeholder="ذكر\أنثى"size="20" required/><br>
<label>رقم الهاتف :</label>
<input type="text" name="fone" placeholder="أدخل رقم الهاتف"/><br>
<label>العنوان :</label>
<input type="text" name="fone" placeholder="أدخل عنوانك"/><br>
<label>البريد الالكتروني :</label>
<input type="email" name="email" placeholder="@email"/><br>
<label>كلمة السر :</label>   
 <input type="password" name="password" placeholder="أدخل كلمة السر"/>
<a href="esraa2001.html"><input type="button" value="متابعة"></a><br><br>
</p>
   </form>
